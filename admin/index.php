            ...
            <div id="content">
                ...
                <div class="container-fluid" style="background-color: linear-gradient(90deg, #164A41 6.67%, #4D774E 56.77%, #9DC88D 106.67%)">
                    ...
                    <div class="row"id="index">
                        <a href="admin.php" style="text-decoration-line: none;"><div class="card ml-2 mr-2" >
                            <div class="card-body">
                                <i class="fas fa-users-cog fa-4x"></i><br><br>
                                <h5 class="card-title">Data Admin</h5>
                            </div></a>
                        </div>
                            <a href="user.php" style="text-decoration-line: none;"><div class="card ml-2 mr-2">
                                <div class="card-body">
                            ...
                            <div class="card ml-2 mr-2">
                                <a href="peminjaman.php" style="text-decoration-line: none;"><div  class="card-body">
                                    <i class="fas fa-calendar-alt fa-4x"></i><br><br>
                                    <h5 class="card-title">Data Peminjaman</h5>
                                </div></a>
                            </div>
                        <div class="card ml-2 mr-2">
                            <a href="pengembalian.php" style="text-decoration-line: none;"><div class="card-body">
                                <i class="fas fa-calendar-check fa-4x"></i><br><br>
                                <h5 class="card-title">Data Pengembalian</h5>
                            </div></a>
                        </div>
                        <div class="card ml-2 mr-2">
                            <a href="ruangan.php" style="text-decoration-line: none;"><div  class="card-body">
