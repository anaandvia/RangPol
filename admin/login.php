...
<a class="navbar-brand" href="../index.php">
    <img src="img/Logo-01.png" width="80px" alt="">
</a>
</nav>
<!-- Akhir Nav -->
    <div class="container">
        ...
        <div class="row justify-content-center" >
            <div class="col-xl-10 col-lg-12 col-md-9" >
                <div class="card o-hidden border-0 shadow-lg my-5" style="background: linear-gradient(90deg, #164A41 6.67%, #4D774E 56.77%, #9DC88D 106.67%);"> 
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" form method="POST" action="cek_login.php">
                                        ...
                                        <button type="submit" class="btn btn-user btn-block" style="background-color: #164A41;color: white;">
                                            Login
                                        </button>
                                    </form>
                                    </div>
