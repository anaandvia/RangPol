...
if($input){
    echo "<script>alert('Data berhasil disimpan.');window.location='fasilitas.php';</script>";
}else{
    echo "<script>alert('Data gagal disimpan.');window.location='fasilitas.php';</script>";
}
?>