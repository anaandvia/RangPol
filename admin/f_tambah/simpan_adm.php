...
if($input){
    echo "<script>alert('Data berhasil disimpan.');window.location='../view/admin.php';</script>";
}else{
    echo "<script>alert('Data gagal disimpan.');window.location='../view/admin.php';</script>";
}
?>