                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <?php 
                                    if(isset($_GET['gagal'])){
                                        echo "<div class='alert fade show alert-dark text-center' role='alert'>NIM Tidak Ditemukan / Tidak Terdaftar
                                ...
                                ?>
                                    <div class="card bg-gradient-light">
                                        <div class="card-body">
                                            <form class="user" form method="POST" action="cek_username.php">
                                                <div class="form-group">
                                                    <input name="nim" class="form-control form-control-user"
                                                        placeholder="Masukan NIM / NIDN / NIP Anda" require>
                                                </div>
