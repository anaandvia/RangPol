    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <div class="container-fluid" style="background-color: linear-gradient(90deg, #164A41 6.67%, #4D774E 56.77%, #9DC88D 106.67%)">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <form class="form-inline my-2 my-lg-0 ml-auto">
                                <a href="#" id="tambahusr" class="btn btn-warning mb-2 btndata">
                                    <i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA PEMINJAMAN</a>&nbsp;
                                <a href="laporan_user.php" class="btn btn-warning mb-2 btndata">
                                ...
                                <input class="form-control mr-sm-2 search" type="search" placeholder="SEARCH"
                                    aria-label="Search" name="cari" style="margin-left: 5cm;margin-bottom:0.7em">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="background-color: white; color:black">
                                    <thead>
                                        <tr style="text-align:center;">
                                            ...
                                            <th>Nama Kegiatan</th>
                                            <th>Tgl Kegiatan</th>
                                            <th>Tgl Akhir Kegiatan</th>
                                            <th>Penanggung Jawab</th>
                                            <th>Pendamping Acara</th>
                                            <th>Pengarah Kegiatan</th>
                                            <th>Jumlah Tamu</th>
                                            <th>Sifat</th>
                                            <th>Jenis</th>
                                            <th>Keterangan</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>1</th>
                                            <th>3311901011</th>
                                            <th>Ana Jannatu Uzlifat</th>
                                            <th>085315194081</th>
                                            <th>LAB 607</th>
                                            <th>Workshop Web</th>
                                            <th>2021/04/06</th>
                                            <th>2021/04/07</th>
                                            <th>Jusriyani Sirait</th>
                                            <th>Tiara Anggraini</th>
                                            <th>Tasya Selvia Ulfa</th>
                                            <th>30</th>
                                            <th>Acara Mahasiswa</th>
                                            <th>Diskusi</th>
                                            <th>-</th>
                                            <th style="color: grey;">Diajukan</th>
                                            <th><a href="#" data-role="pop"
                                                    data-id=""><i
                                                        class="fas fa-edit bg-success p-2 text-white rounded"></i></a>
                                                <a href="#" data-role="pop2"
                                                    data-id=""><i
                                                        class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i></a></th>
                                        </tr>
                                        <tr>
                                            <th>2</th>
                                            <th>3311901055</th>
                                            ...
                                            <th>Diskusi</th>
                                            <th>-</th>
                                            <th style="color: green;">Disetujui</th>
                                            <th><a href="#" data-role="pop"
                                                    data-id=""><i
                                                        class="fas fa-edit bg-success p-2 text-white rounded"></i></a>
                                                <a href="#" data-role="pop2"
