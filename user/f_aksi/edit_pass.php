<?php
    ...
    if ($v_pass != true) {
        echo "<script>alert('Password tidak sesuai , Ulang Kembali!!.');window.location='e_profile.php';</script>";
    }
    //validasi input konfirm password
    else if ($password_baru != $konf_password) {
        echo "<script>alert('Password baru tidak sama , Ulang Kembali!!.');window.location='e_profile.php';</script>";
    }
    else {
    //update data
    ...
    if ($sql2) {
        echo "<script>alert('Password Berhasil Diubah.');window.location='e_profile.php';</script>";   
    } else {
        echo "<script>alert('Password Gagal Diubah');window.location='e_profile.php';</script>";   
    }
    }
?>