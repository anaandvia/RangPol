        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid"
                    ...
                    <!-- Content Row -->
                    <div class="row">
                        <a href="peminjaman.php"><div class="card ml-2 mr-2">
                            <img src="img/r1.jpg" class="card-img" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">TA 707</h5>
                                <!-- <bagde class="badge badge-success">available</bagde> -->
                            </div>
                        </div></a>
                        <div class="card ml-2 mr-2">
                            ...
                            <div class="card-body">
                                ...
                                <!-- <bagde class="badge badge-danger">Not available</bagde> -->
                            </div>
                        </div>
                        <div class="card ml-2 mr-2">
                            <img src="img/r1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">TA 102</h5>
                                <!-- <bagde class="badge badge-danger">Diajukan</bagde> -->
                            </div>
                        </div>
                        <div class="card ml-2 mr-2">
                            <img src="img/r1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">LAB 201</h5>
                                <!-- <bagde class="badge badge-danger">Diajukan</bagde> -->
                            </div>
                        </div>
                        <div class="card ml-2 mr-2">
                            <img src="img/r1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">LAB 302</h5>
                                <!-- <bagde class="badge badge-danger">Diajukan</bagde> -->
                            </div>
                        </div>
                        <div class="card ml-2 mr-2">
                        ...
                        <div class="card ml-2 mr-2">
                            <img src="img/r1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">LAB 103</h5>
                                <!-- <bagde class="badge badge-danger">Diajukan</bagde> -->
                            </div>
                        </div>
                        <div class="card ml-2 mr-2">
                            <img src="img/r1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">LAB 405</h5>
                                <!-- <bagde class="badge badge-danger">Diajukan</bagde> -->
                            </div>
                        </div>
                    </div>
