                    ...
                    <div class="col-lg-6">
                        <form style="color: white;">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nim" name="nim" value="3311901011" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" id="nama" name="nama" value="Ana Jannatu Uzlifat">
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email" class="form-control" id="email" name="email" value="auzlifat@gmail.com">
                            </div>
                            <div class="form-group">
                                <label for="no_tlp">No. Telp</label>
                                <input type="text" class="form-control" id="text" name="no_tlp" value="085315194081">
